...
def extract_unique_slides_mse(video_path, mse_threshold=2000):
...
def videotodataframe(url) -> pd.DataFrame :
    ...
    transcription(url, duration_threshold=20.0)
    dict_time=extract_unique_slides_mse(video_path, mse_threshold=2000)
    ...
    df_slides['text'] = transcript_list
